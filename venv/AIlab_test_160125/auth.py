#TODO add a way to stop new account registration
import functools
    ...
    if request.method == 'POST':
        ...
        if error is None:
            try:
                ...
                db.execute( "INSERT INTO coin_balance (gold, silver, copper) VALUES (?, ?, ?)", (999,999,999)) #FIXME decide how many coins sould be given to a new account
                db.commit()
            except db.IntegrityError: error = f"User {username} is already registered."
